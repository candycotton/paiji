...
// +----------------------------------------------------------------------
// $Id: Dispatcher.class.php 349 2012-01-12 08:34:35Z luofei614@126.com $
 ...
 * @subpackage  Util
 * @author    liu21st <liu21st@gmail.com>
 * @version   $Id: Dispatcher.class.php 349 2012-01-12 08:34:35Z luofei614@126.com $
 +------------------------------------------------------------------------------
 */
class Dispatcher {
    ...
    static public function dispatch() {
        ...
        if(!empty($_SERVER['PATH_INFO'])) {
            ...
            if(!self::routerCheck()){   // 检测路由规则 如果没有则按默认规则调度URL
                ...
                // 直接通过$_GET[1] $_GET[2] 获取URL参数 方便不用路由时参数获取
                $_GET   =  array_merge($paths,$_GET);
                $var  =  array();
